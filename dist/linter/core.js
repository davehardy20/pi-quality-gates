...
export function filterBuiltInIgnoredFiles(filePaths) {
    return filePaths.filter((f) => !pipelineTest.isBuiltInIgnoredAgentArtifact(f));
}
export const __test__ = {
    parseJsoncConfig: async (...args) => (await import("./config-loader.js")).parseJsoncConfig(...args),
    loadMarkdownlintConfig: async (...args) => (await import("./config-loader.js")).loadMarkdownlintConfig(...args),
    loadLinterConfig: async (...args) => (await import("./config-loader.js")).loadLinterConfig(...args),
    getLinterForFile,
    mergeValidationOutcomes,
    buildCodeExcerptSection,
    extractIssueLocations: async (...args) => (await import("./report-builder.js")).extractIssueLocations(...args),
    extractAffectedFiles: async (...args) => (await import("./report-builder.js")).extractAffectedFiles(...args),
    buildCombinedSignature: async (...args) => (await import("./outcome-merger.js")).buildCombinedSignature(...args),
    isBuiltInIgnoredAgentArtifact,
    filterBuiltInIgnoredFiles,
    formatMarkdownlintResults: async (...args) => (await import("./config-loader.js")).formatMarkdownlintResults(...args),
    groupFilesByLinter,
};
