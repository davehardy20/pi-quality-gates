 ...
 */
export async function installLanguageServer(_serverId, binaryName, cwd) {
    // Already installed?
 ...
 */
export function getInstallInstructions(binaryName) {
    const commands = {
