...
export type ReviewerPhase = "IDLE" | "GATHERING" | "REVIEWING" | "FIX_REQUESTED" | "RE_REVIEWING";
/** The 7-domain review checklist categories. */
export type ReviewDomain = "task-completion" | "correctness" | "error-handling" | "security" | "quality" | "testing" | "documentation";
